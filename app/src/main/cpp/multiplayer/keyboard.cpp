...
void CKeyBoard::InitRU()
{
    ...
    key.width = defWidth;
    key.code[LOWER_CASE] = U'й';
    key.code[UPPER_CASE] = U'Й';
    ...
    key.symPos = ImVec2(curPos.x + defWidth * 0.4f, curPos.y + m_fKeySizeY * 0.2f);
    key.width = defWidth;
    key.code[LOWER_CASE] = U'ц';
    key.code[UPPER_CASE] = U'Ц';
    ...
    key.symPos = ImVec2(curPos.x + defWidth * 0.4f, curPos.y + m_fKeySizeY * 0.2f);
    key.width = defWidth;
    key.code[LOWER_CASE] = U'у';
    key.code[UPPER_CASE] = U'У';
    ...
    key.symPos = ImVec2(curPos.x + defWidth * 0.4f, curPos.y + m_fKeySizeY * 0.2f);
    key.width = defWidth;
    key.code[LOWER_CASE] = U'к';
    key.code[UPPER_CASE] = U'К';
    ...
    key.symPos = ImVec2(curPos.x + defWidth * 0.4f, curPos.y + m_fKeySizeY * 0.2f);
    key.width = defWidth;
    key.code[LOWER_CASE] = U'е';
    key.code[UPPER_CASE] = U'Е';
    ...
    key.symPos = ImVec2(curPos.x + defWidth * 0.4f, curPos.y + m_fKeySizeY * 0.2f);
    key.width = defWidth;
    key.code[LOWER_CASE] = U'н';
    key.code[UPPER_CASE] = U'Н';
    ...
    key.symPos = ImVec2(curPos.x + defWidth * 0.4f, curPos.y + m_fKeySizeY * 0.2f);
    key.width = defWidth;
    key.code[LOWER_CASE] = U'г';
    key.code[UPPER_CASE] = U'Г';
    ...
    key.symPos = ImVec2(curPos.x + defWidth * 0.4f, curPos.y + m_fKeySizeY * 0.2f);
    key.width = defWidth;
    key.code[LOWER_CASE] = U'ш';
    key.code[UPPER_CASE] = U'Ш';
    ...
    key.symPos = ImVec2(curPos.x + defWidth * 0.4f, curPos.y + m_fKeySizeY * 0.2f);
    key.width = defWidth;
    key.code[LOWER_CASE] = U'щ';
    key.code[UPPER_CASE] = U'Щ';
    ...
    key.symPos = ImVec2(curPos.x + defWidth * 0.4f, curPos.y + m_fKeySizeY * 0.2f);
    key.width = defWidth;
    key.code[LOWER_CASE] = U'з';
    key.code[UPPER_CASE] = U'З';
    ...
    key.symPos = ImVec2(curPos.x + defWidth * 0.4f, curPos.y + m_fKeySizeY * 0.2f);
    key.width = defWidth;
    key.code[LOWER_CASE] = U'х';
    key.code[UPPER_CASE] = U'Х';
    ...
    key.symPos = ImVec2(curPos.x + defWidth * 0.4f, curPos.y + m_fKeySizeY * 0.2f);
    key.width = defWidth;
    key.code[LOWER_CASE] = U'ф';
    key.code[UPPER_CASE] = U'Ф';
    ...
    key.symPos = ImVec2(curPos.x + defWidth * 0.4f, curPos.y + m_fKeySizeY * 0.2f);
    key.width = defWidth;
    key.code[LOWER_CASE] = U'ы';
    key.code[UPPER_CASE] = U'Ы';
    ...
    key.symPos = ImVec2(curPos.x + defWidth * 0.4f, curPos.y + m_fKeySizeY * 0.2f);
    key.width = defWidth;
    key.code[LOWER_CASE] = U'в';
    key.code[UPPER_CASE] = U'В';
    ...
    key.symPos = ImVec2(curPos.x + defWidth * 0.4f, curPos.y + m_fKeySizeY * 0.2f);
    key.width = defWidth;
    key.code[LOWER_CASE] = U'а';
    key.code[UPPER_CASE] = U'А';
    ...
    key.symPos = ImVec2(curPos.x + defWidth * 0.4f, curPos.y + m_fKeySizeY * 0.2f);
    key.width = defWidth;
    key.code[LOWER_CASE] = U'п';
    key.code[UPPER_CASE] = U'П';
    ...
    key.symPos = ImVec2(curPos.x + defWidth * 0.4f, curPos.y + m_fKeySizeY * 0.2f);
    key.width = defWidth;
    key.code[LOWER_CASE] = U'р';
    key.code[UPPER_CASE] = U'Р';
    ...
    key.symPos = ImVec2(curPos.x + defWidth * 0.4f, curPos.y + m_fKeySizeY * 0.2f);
    key.width = defWidth;
    key.code[LOWER_CASE] = U'о';
    key.code[UPPER_CASE] = U'О';
    ...
    key.symPos = ImVec2(curPos.x + defWidth * 0.4f, curPos.y + m_fKeySizeY * 0.2f);
    key.width = defWidth;
    key.code[LOWER_CASE] = U'л';
    key.code[UPPER_CASE] = U'Л';
    ...
    key.symPos = ImVec2(curPos.x + defWidth * 0.4f, curPos.y + m_fKeySizeY * 0.2f);
    key.width = defWidth;
    key.code[LOWER_CASE] = U'д';
    key.code[UPPER_CASE] = U'Д';
    ...
    key.symPos = ImVec2(curPos.x + defWidth * 0.4f, curPos.y + m_fKeySizeY * 0.2f);
    key.width = defWidth;
    key.code[LOWER_CASE] = U'ж';
    key.code[UPPER_CASE] = U'Ж';
    ...
    key.symPos = ImVec2(curPos.x + defWidth * 0.4f, curPos.y + m_fKeySizeY * 0.2f);
    key.width = defWidth;
    key.code[LOWER_CASE] = U'э';
    key.code[UPPER_CASE] = U'Э';
    ...
    key.symPos = ImVec2(curPos.x + defWidth * 0.4f, curPos.y + m_fKeySizeY * 0.2f);
    key.width = defWidth;
    key.code[LOWER_CASE] = U'я';
    key.code[UPPER_CASE] = U'Я';
    ...
    key.symPos = ImVec2(curPos.x + defWidth * 0.4f, curPos.y + m_fKeySizeY * 0.2f);
    key.width = defWidth;
    key.code[LOWER_CASE] = U'ч';
    key.code[UPPER_CASE] = U'Ч';
    ...
    key.symPos = ImVec2(curPos.x + defWidth * 0.4f, curPos.y + m_fKeySizeY * 0.2f);
    key.width = defWidth;
    key.code[LOWER_CASE] = U'с';
    key.code[UPPER_CASE] = U'С';
    ...
    key.symPos = ImVec2(curPos.x + defWidth * 0.4f, curPos.y + m_fKeySizeY * 0.2f);
    key.width = defWidth;
    key.code[LOWER_CASE] = U'м';
    key.code[UPPER_CASE] = U'М';
    ...
    key.symPos = ImVec2(curPos.x + defWidth * 0.4f, curPos.y + m_fKeySizeY * 0.2f);
    key.width = defWidth;
    key.code[LOWER_CASE] = U'и';
    key.code[UPPER_CASE] = U'И';
    ...
    key.symPos = ImVec2(curPos.x + defWidth * 0.4f, curPos.y + m_fKeySizeY * 0.2f);
    key.width = defWidth;
    key.code[LOWER_CASE] = U'т';
    key.code[UPPER_CASE] = U'Т';
    ...
    key.symPos = ImVec2(curPos.x + defWidth * 0.4f, curPos.y + m_fKeySizeY * 0.2f);
    key.width = defWidth;
    key.code[LOWER_CASE] = U'ь';
    key.code[UPPER_CASE] = U'Ь';
    ...
    key.symPos = ImVec2(curPos.x + defWidth * 0.4f, curPos.y + m_fKeySizeY * 0.2f);
    key.width = defWidth;
    key.code[LOWER_CASE] = U'б';
    key.code[UPPER_CASE] = U'Б';
    ...
    key.symPos = ImVec2(curPos.x + defWidth * 0.4f, curPos.y + m_fKeySizeY * 0.2f);
    key.width = defWidth;
    key.code[LOWER_CASE] = U'ю';
    key.code[UPPER_CASE] = U'Ю';
